...
import { editUserStoryFormSchema } from "@/schemas/forms/user-story"
...
export const EditUserStoryForm = ({ userStory }: any) => {
  const form = useForm({
    resolver: zodResolver(editUserStoryFormSchema),
    defaultValues: {
      nom: userStory.nom,
      description: userStory.description,
      identifiant: userStory.identifiant,
      priorite: userStory.priorite,
      us_etat: userStory.us_etat,
      technologies: userStory.technologies,
      complexite: userStory.complexite,
      estimation_initiale: userStory.estimation_initiale,
      date_range_estim: {
        from: userStory.date_range_estim.from,
        to: userStory.date_range_estim.to,
      },
      date_range_effective: {
        from: userStory.date_range_effective.from,
        to: userStory.date_range_effective.to,
      },
      commentaires: userStory.commentaires,
    }
  })
